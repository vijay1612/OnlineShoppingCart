...
import static com.gmail.vijay.ecommerce.util.TestConstants.USER_EMAIL;
import static com.gmail.vijay.ecommerce.util.TestConstants.USER_FIRST_NAME;
...
@Sql(value = { "/sql/create-perfumes-before.sql",
        "/sql/create-user-before.sql" }, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
